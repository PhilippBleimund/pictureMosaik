...
public class SynchronousJFXDirectoryChooser {
     ...
     * @param <T> the return type of the method, usually Directory or List&lt;Directory&gt;
     ...
     * </p>
     * @param <T> return type (usually Directory or List&lt;Directory&gt;)
    ...
    public File showOpenDialog() {
        return (File) showDialog(chooser -> chooser.showDialog(null));
    }
